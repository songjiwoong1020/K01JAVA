...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		 ...
		 */
		char ch1 = '가';
//		char chStr = "가나다라";[에러발생]문자'열'이므로 char형 변수에 대입불가
		String chStr = "가나다라";
		...
		char ch4 = '1';
		char ch4_1 = '1' + 1; //숫자가 아니라 문자 1이므로 49로 저장된다.
		...
		System.out.println(ch4_1);
		System.out.println(ch4_1+3);
		System.out.println((int)ch4_1+3);
		*/
		

		/*
		boolean형 ㅣ true 혹은 false 두가지의 값만 가질수 있는 데이터형으로
