...
//		System.out.println("one.privateVar="+one.privateVar);//에러발생
		System.out.println("one.defaultVal="+one.defaultVal);
		System.out.println("one.publicVal="+one.publicVal);
...
//		System.out.println("two.defaultVal="+two.defaultVal);//에러발생
		System.out.println("two.publicVal="+two.publicVal);
