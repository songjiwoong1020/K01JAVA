...
class FruitSeller3{
	...
	public FruitSeller3(int money, int appleNum, int price) {
		myMoney = money;
		numOfApple = appleNum;
		APPLE_PRICE = price;// <= 생성자 내에서는 상수를 초기화 할수있음.
	}
...
public class E02FruitSalesMain5 {
	...
	public static void main(String[] args) {
		...
		buyer.numOfApple += 50;//판매자2에게 1000원을 지불하고
		seller2.myMoney += 1000;//사과 70개를 구매하였다.
		seller2.numOfApple -=70;//하지만 구매자의 보유금액은 차감되지 않았다.
		buyer.numOfApple += 70;
