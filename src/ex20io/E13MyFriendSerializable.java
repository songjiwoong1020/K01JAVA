...
//
///*
//연습문제 ] 해당 프로그램은 친구의 정보를 저장하게 된다. 프로그램을
...
//	private int numOfFriends;//친구정보를 추가할때매다 +1 증가
//	
...
//	2. High객체가 Friend타입으로 자동 형변환되어 저장
//	3. 객체배열에 저장된 객체들을 for문을 통해 순차적으로 출력
//		이때 오버라이딩된 메소드를 통해 항상 해당 객체의
//		정보를 출력할수 있음. (참조변수의 타입에 영향을 받지 않음)
//	 */
